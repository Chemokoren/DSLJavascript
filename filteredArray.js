...
// items meet a certain set of criteria. JavaScript offers several built in methods that each iterate
// over arrays in slightly different ways to achieve different results (such as every(), forEach(), map(), etc.),
...
// of the arrays nested within arr. Modify the function, using a for loop, to return a filtered version of
...
let myNestedArray = [                           //1
    ...
    ['loop', 'shift', 6, 7, 'deep',1000, 'method'],     //3
    ['concat', false, 'true', 'spread', 'array'],       //4
    ['mutate', 1327.98, 'splice', 'slice', 'push'],     //5
    ['iterate', 1.3849, 7, '8.4876', 'arbitrary', 'depth'] //6
    // Only change code above this line
];
